...
.event-alert__bottom::before {
  content: "";
  position:absolute;
  right: 0;
  bottom:0;
  background: url('~@/assets/img/eventalert.png');
  height: 200px;
  width: 193px;
}
.event-alert__headline {
  font-weight: bold;
  font-size: 24px;
}
...
.event-alert__button {
  ...
  border-radius: 5px;
  margin-top: 25px;
  background: linear-gradient(0deg, #2ed471 50%, #3adc7b 0%);
  cursor: pointer;
  color: white;
}
.event-alert__logo {
...
.event-alert__close::after {
  content: "\00d7";
}

.event-alert__button:hover {
  font-weight: 400;
  border-color: #a5a5a5;
}
</style>